...
regimes <- dat[c("meta", "meta.dd.paed", "meta.nf.dd.paed","OU1")]
...
fitComparison <- function(data) {
  ...
  ##################################################################
  ## Pairwise comparision 5. meta.nf.dd.paed (OUMV) versus meta.nf (OUMV) ##
  ##################################################################
...
system.time(fitComparison(PMCdata[[1]]))

numCores <- detectCores()
PMCfits <- vector(mode='list', length=500)
for (i in 1:5) {
  print(i)
  mclapply(PMCdata[((i-1)*100+1):(100*i)],
           fitComparison,
           mc.cores=numCores) -> fits
  PMCfits[((i-1)*100+1):(100*i)] <- fits
