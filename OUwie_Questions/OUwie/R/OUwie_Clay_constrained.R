...
OUwie.Clay <-function(phy, data, model=c("OU1","OUM","OUMV","OUMA","OUMVA"), alpha, sigma.sq, simmap.tree=FALSE, scaleHeight=FALSE, root.station=TRUE, lb=0.000001, ub=1000, clade=NULL, mserr="none", diagn=FALSE, quiet=FALSE){
